...
export default function OfficeHoursCheckInPage() {
  ...
  return (
    <PageShell
      title="Office Hours action"
      description="Take a fresh selfie to check in, or confirm check-out if you already have an open session."
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">
                  {mode === "check_out" ? "Active session" : "Selfie check-in"}
                </p>
          ...
          >
            ...
            <section className="rounded-[1.7rem] border border-white/75 bg-white/76 p-5 backdrop-blur-xl">
              ...
              <div className="mt-3 space-y-3 text-sm leading-6 text-slate-600">
                <p>Office Hours now runs inside the signed-in member app flow instead of the public member-picker kiosk.</p>
                <p>Check-in still requires a fresh selfie and geofence validation, while checkout stays intentionally lightweight.</p>
                <p>Trusted browsers keep routine sign-ins fast without dropping the first-time or unfamiliar-browser email check.</p>
              </div>
            </section>
          </motion.aside>
        </div>
