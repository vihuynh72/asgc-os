  ...
  return (
    <KioskShell>
      ...
      <KioskStickyAction
        status={
          <KioskStatusChip
            tone={openSession ? "warning" : "good"}
            icon={openSession ? "clock" : "check"}
            label={openSession ? "Already checked in" : "Ready to check in"}
          />
        }
        primary={
          <Button
          ...
          >
            {loading ? "Checking in…" : openSession ? "Already checked in" : "Check in"}
          </Button>
        }
        secondary={
          <div className="flex gap-2">
            <Link
              href={openSession ? "/office-hours/check-out" : "/office-hours/kiosk"}
            ...
            >
              {openSession ? "Open check-out page" : "Open kiosk"}
            </Link>
            <Button
              variant="outline"
