-- PATCH — Fix admin_weekly_hours "user_id is ambiguous"
--
-- In PL/pgSQL, output column names are variables in scope. The previous query selected
-- unqualified `user_id`, which can be ambiguous. Qualify all selected fields.
