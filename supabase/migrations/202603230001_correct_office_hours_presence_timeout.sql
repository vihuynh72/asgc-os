-- PATCH — Correct Office Hours presence timeout policy
--
-- Restores the intended behavior:
-- - no inactivity auto-close during the day
-- - after 5:00 PM office time, stale presence auto-closes after 15 minutes
-- - outside-geofence still auto-closes immediately
--
-- This is a corrective migration for environments that may still be running
-- the older 1-minute presence-timeout function bodies.
